<?php if($paginator->hasPages()): ?>
    <nav>
        <ul class="pagination">
            ...
            <?php else: ?>
                <a href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>"><li>
                    &lsaquo;
                </li></a>
            <?php endif; ?>
            ...
            <?php if($paginator->hasMorePages()): ?>
                <a href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>"><li>
                    &rsaquo;
                </li></a>
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\prj\DAW\marketplace_github\Marketplace\marketPlace\resources\views/vendor/pagination/default.blade.php ENDPATH**/ ?>