                ...
                <div class="avatar-upload">
                    ...
                    <div class="avatar-preview">
                        <div id="imagePreview" class="avatar-preview-img">
                            ...
                            <img id="shopImg" src="<?php echo e(asset('storage/img/profile/' . Auth::user()->path)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\prj\DAW\marketplace_github\Marketplace\marketPlace\resources\views/shop/createNewShop.blade.php ENDPATH**/ ?>